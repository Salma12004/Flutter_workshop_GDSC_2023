...
void main(List<String> args) {
  ...
  Map<String, int> sortedAlphabets=Map.fromEntries(alphabets.entries.toList()..sort((e1, e2) => e1.key.compareTo(e2.key)));
  // alphabets.forEach((key, value) { 
  //   alphabets.forEach((key2, value2) {
  //     if(value>value2){
  //       sortedAlphabets[key2]=value2;
  //     }
  //   });
  //    sortedAlphabets[key]=value;
  // });
